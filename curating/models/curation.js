...
const CurationSchema = new mongoose.Schema({
  ...
  trendy: { type: Number, required: true }, //트렌디 점수
  personality: { type: Number, required: true }, //개성 점수
  practicality: { type: Number, required: true }, //실용성 점수
  costEffectiveness: { type: Number, required: true }, //가성비 점수
